...
describe('isEnabledForHost', () => {
  const base: Settings = { globalEnabled: true, siteOverrides: {}, disabledCategories: [], dictionary: [], uiLanguage: 'auto', defaultTone: '', defaultStyles: [], defaultLength: 'asis', theme: 'auto' as const, correctionOrder: [], correctionDisabled: [], selectionActionsDisabled: [], languageToolEndpoint: 'https://api.languagetool.org/v2', languageToolPicky: false };
...
describe('effectiveLang', () => {
  const base = { globalEnabled: true, siteOverrides: {}, disabledCategories: [], dictionary: [], defaultTone: '', defaultStyles: [], defaultLength: 'asis', theme: 'auto' as const, correctionOrder: [], correctionDisabled: [], selectionActionsDisabled: [], languageToolEndpoint: 'https://api.languagetool.org/v2', languageToolPicky: false };
