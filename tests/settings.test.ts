...
describe('isEnabledForHost', () => {
  const base: Settings = { globalEnabled: true, siteOverrides: {}, disabledCategories: [], dictionary: [], uiLanguage: 'auto', defaultTone: '', theme: 'auto' as const, autoSuggest: true, languageToolEnabled: false, languageToolEndpoint: 'https://api.languagetool.org/v2' };
...
describe('getSettings/setSettings', () => {
  ...
  it('round-trips and merges over defaults', async () => {
    await setSettings({ globalEnabled: false, siteOverrides: { 'x.com': true }, disabledCategories: [], dictionary: [], uiLanguage: 'auto', defaultTone: '', theme: 'auto' as const, autoSuggest: true, languageToolEnabled: false, languageToolEndpoint: 'https://api.languagetool.org/v2' });
...
describe('category transforms', () => {
  const base = { globalEnabled: true, siteOverrides: {}, disabledCategories: [] as string[], dictionary: [] as string[], uiLanguage: 'auto' as const, defaultTone: '', theme: 'auto' as const, autoSuggest: true, languageToolEnabled: false, languageToolEndpoint: 'https://api.languagetool.org/v2' };
...
describe('effectiveLang', () => {
  const base = { globalEnabled: true, siteOverrides: {}, disabledCategories: [], dictionary: [], defaultTone: '', theme: 'auto' as const, autoSuggest: true, languageToolEnabled: false, languageToolEndpoint: 'https://api.languagetool.org/v2' };
